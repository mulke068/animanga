  ...
  <div class="bg-gradient-to-b from-purple-500 to-pink-500 py-8">
    <div class="container mx-auto">
      <nav class="flex space-x-4 items-center justify-center">
        ...
        <button @click="refresh" class="bg-pink-600 hover:bg-pink-700 text-white py-2 px-4 rounded-full focus:outline-none">Refresh</button>
      </nav>
      ...
      <div class="bg-white p-8 mt-8 rounded-lg shadow-lg">
        ...
        <div class="mt-6">
          ...
          <div class="flex flex-wrap space-x-2 mt-2">
            <div v-for="type in data.types" class="bg-purple-500 text-white rounded-full px-2 py-1">{{ type }}</div>
          </div>
        </div>
        ...
        <div class="mt-6">
          ...
          <div class="flex flex-wrap space-x-2 mt-2">
            <div v-for="platform in data.platforms" class="bg-purple-500 text-white rounded-full px-2 py-1">{{ platform }}</div>
          </div>
        </div>
        ...
        <div class="mt-6">
          ...
          <div class="flex flex-wrap space-x-2 mt-2">
            <div v-for="genre in data.genres" class="bg-purple-500 text-white rounded-full px-2 py-1">{{ genre }}</div>
          </div>
        </div>
        ...
        <div class="mt-6">
          ...
          <div class="flex flex-wrap space-x-2 mt-2">
            <div v-for="tag in data.tags" class="bg-purple-500 text-white rounded-full px-2 py-1">{{ tag }}</div>
          </div>
        </div>
        ...
        <div class="mt-6">
          ...
          <div class="space-y-2 mt-2">
            <div v-for="trailer_url in data.trailer_urls">
              <NuxtLink :to="trailer_url" class="text-blue-600 hover:underline">{{ trailer_url }}</NuxtLink>
            </div>
          </div>
        </div>
