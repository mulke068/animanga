...
const { data: setData , refresh} = await useFetch(`/api/anime/${id}`, { key: `${id}` });
const data: Anime = setData;
    ...
    <div class="break-all">
      <div class="mt-4">
        ...
        <div class="flex flex-wrap space-x-2 mt-2">
          <div v-for="type in data.types" class="bg-blue-200 text-blue-700 dark:bg-green-400 dark:text-green-900 rounded-full px-2 py-1 mt-2">{{ type }}</div>
        </div>
      </div>
     ...
     <div class="mt-4">
        ...
        <div class="flex flex-wrap space-x-2 mt-2">
          <div v-for="platform in data.platforms" class="bg-blue-200 text-blue-700 dark:bg-green-400 dark:text-green-900  rounded-full px-2 py-1 mt-2">{{ platform }}</div>
        </div>
      </div>
      ...
      <div class="mt-4">
        ...
        <div class="flex flex-wrap space-x-2 mt-2">
          <div v-for="genre in data.genres" class="bg-blue-200 text-blue-700 dark:bg-green-400 dark:text-green-900 rounded-full px-2 py-1 mt-2">{{ genre }}</div>
        </div>
      </div>
      ...
      <div class="mt-4">
        ...
        <div class="flex flex-wrap space-x-2 mt-2">
          <div v-for="tag in data.tags" class="bg-blue-200 text-blue-700 dark:bg-green-400 dark:text-green-900 rounded-full px-2 py-1 mt-2">{{ tag }}</div>
        </div>
      </div>
