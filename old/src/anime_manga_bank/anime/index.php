...
<body class="antialiased text-slate-500 dark:text-slate-400 bg-white dark:bg-slate-900">
    <div class="max-w-sm mx-auto bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-200 shadow pt-6 pb-4 px-6">
        <form action="data/anime.php" method="GET" autocomplete="off">
            <div >
                <label class="inline-block text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight dark:text-slate-200" for="pass">anime</label>
                <div class="mt-1">
        ...
        <!--div>
            ...
            <button><a href="output.php?db=anime_bank">Anime</a></button>
            <button><a href="output.php?db=manga_bank">Manga</a></button>
        </div-->
