...
CREATE DATABASE IF NOT EXISTS `anime_bank` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `anime_bank`;


CREATE TABLE IF NOT EXISTS `status` (
  `status_id` int NOT NULL DEFAULT '0',
  `status_name` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `user` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pass` int DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `anime` (
  ...
  `platform` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '{}',
  `link` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `img` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'https://fl-1.cdn.flockler.com/embed/no-image.svg ',
...
INSERT INTO `anime` (`user_id`, `anime_id`, `name`, `name2`, `status_id`, `season`, `episodes`, `watched`, `date`, `score`, `platform`, `link`, `img`) VALUES
	...
	(1, 5, 'Violet Evergarden: The Day You Understand ', 'Violet Evergarden: Kitto ', 3, 2, 1, 1, '2022-10-01', 4, '{Netflix}', 'https://bs.to/serie/Violet-Evergarden', 'https://cdn.myanimelist.net/images/anime/9/89993.jpg'),
	...
	(1, 19, 'Hyouka', '', 1, 1, 22, 7, '2022-11-02', 1, '{Crunchyroll;Funimation}', 'https://bs.to/serie/Hyouka', 'https://cdn.myanimelist.net/images/anime/13/50521.jpg'),
	(1, 20, 'Gangsta.', '', 0, 1, 12, 12, '2022-11-02', 3, '{}', 'https://bs.to/serie/Gangsta', 'https://cdn.myanimelist.net/images/manga/2/160089.jpg'),
	(1, 21, 'The Dungeon of Black Company', 'Meikyuu Black Company', 1, 1, 12, 5, '2022-11-02', 0, '{Crunchyroll;Funimation;Bilibili;Wakanim}', 'https://bs.to/serie/Meikyuu-Black-Company-The-Dungeon-of-Black-Company', 'https://cdn.myanimelist.net/images/anime/1753/116290.jpg'),
	(1, 22, 'The Case Study of Vanitas', 'Vanitas no Karte', 1, 1, 12, 0, '2022-11-02', 0, '{Crunchyroll;Funimation;Aniplus Asia;Aniplus TV;Bahamut Anime Crazy;Bilibili;Hulu;Laftel;Wakanim;iQIYI}', 'https://bs.to/serie/Vanitas-no-Karte-The-Case-Study-of-Vanitas', 'https://cdn.myanimelist.net/images/anime/1401/118483.jpg'),
	(1, 23, 'The Case Study of Vanitas Part 2', 'Vanitas no Karte Part 2', 1, 2, 12, 0, '2022-11-02', 0, '{Crunchyroll;Funimation;AIS Play;Aniplus Asia;Aniplus TV;Bahamut Anime Crazy;Bilibili;Hulu;Laftel;Wakanim;iQIYI}', 'https://bs.to/serie/Vanitas-no-Karte-The-Case-Study-of-Vanitas', 'https://cdn.myanimelist.net/images/anime/1247/120579.jpg'),
	(1, 24, 'Juni Taisen: Zodiac War', 'Juuni Taisen', 1, 1, 12, 0, '2022-11-02', 0, '{Crunchyroll;Funimatio;Netflix}', 'https://bs.to/serie/Juuni-Taisen-Juni-Taisen-Zodiac-War', 'https://cdn.myanimelist.net/images/anime/5/87684.jpg'),
	(1, 25, 'High-Rise Invasion', 'Tenkuu Shinpan', 1, 1, 12, 0, '2022-11-02', 0, '{Netflix}', 'https://bs.to/serie/Tenkuu-Shinpan-High-Rise-Invasion', 'https://cdn.myanimelist.net/images/anime/1547/117947.jpg');
...
CREATE DATABASE IF NOT EXISTS `manga_bank`;
USE `manga_bank`;
...
INSERT INTO `manga` (`user_id`, `manga_id`, `name`, `name2`, `status_id`, `chapters`, `watched`, `date`, `score`, `link`, `img`) VALUES
	...
	(1, 2, 'Tomb Raider King', '도굴왕', 0, 354, 58, '2022-10-07', 0, 'https://readmanganato.com/manga-eu982203', 'https://avt.mkklcdnv6temp.com/42/y/18-1583498764.jpg'),
	...
	(1, 6, 'Match Made In Heaven By Chance', '	 Maybe Meant to Be', 0, 40, 28, '2022-10-07', 0, 'https://readmanganato.com/manga-nl991146', 'https://avt.mkklcdnv6temp.com/3/c/26-1654856033.jpg'),
...
CREATE DATABASE IF NOT EXISTS `test_bank` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `test_bank`;

CREATE TABLE IF NOT EXISTS `status` (
  `statusId` int NOT NULL DEFAULT '0',
  `statusName` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `anime` (
  ...
  `animeId` int unsigned NOT NULL AUTO_INCREMENT,
  ...
  `platform` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '{}',
  `link` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `img` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT 'https://fl-1.cdn.flockler.com/embed/no-image.svg ',
  PRIMARY KEY (`animeId`) USING BTREE,
  KEY `usersId` (`usersId`),
  KEY `statusId` (`statusId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

INSERT INTO `anime` (`usersId`, `animeId`, `name`, `name2`, `statusId`, `season`, `episodes`, `watched`, `date`, `score`, `platform`, `link`, `img`) VALUES
	(1, 1, 'King\'s Raid: Successors of the Will', 'King\'s Raid: Ishi wo Tsugumono-tachi', 1, 1, 26, 26, '2022-09-29', 2, '{Funimation}', 'https://bs.to/serie/Kings-Raid-Ishi-wo-Tsugumono-tachi', 'https://cdn.myanimelist.net/images/anime/1885/109122.jpg'),
	(1, 2, 'Violet Evergarden', 'ヴァイオレット・エヴァーガーデン', 0, 1, 13, 13, '2022-09-30', 4, '{Netflix}', 'https://bs.to/serie/Violet-Evergarden', 'https://cdn.myanimelist.net/images/anime/1795/95088.jpg'),
	(1, 3, 'Violet Evergarden the Movie', '劇場版 ヴァイオレット・エヴァーガーデン', 3, 4, 1, 1, '2022-09-30', 4, '{Netflix}', 'https://bs.to/serie/Violet-Evergarden', 'https://cdn.myanimelist.net/images/anime/1825/110716.jpg');
...
INSERT INTO `manga` (`usersId`, `mangaId`, `name`, `name2`, `statusId`, `chapters`, `watched`, `date`, `score`, `link`, `img`) VALUES
	(1, 1, 'The Eminence In Shadow', 'Kage no Jitsuryokusha ni Naritakute', 0, 44, 0, '2022-10-05', 5, 'https://readmanganato.com/manga-de980539', 'https://avt.mkklcdnv6temp.com/32/m/17-1583496423.jpg'),
	(1, 2, 'Tomb Raider King', '도굴왕', 0, 354, 58, '2022-10-07', 0, 'https://readmanganato.com/manga-eu982203', 'https://avt.mkklcdnv6temp.com/42/y/18-1583498764.jpg'),
	(1, 3, 'Pure Villain', 'O amor puro de um vilão', 0, 17, 17, '2022-10-05', 5, 'https://readmanganato.com/manga-oa992083', 'https://avt.mkklcdnv6temp.com/43/e/26-1661564380.jpg');
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `usersName` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `usersEmail` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `usersUid` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
